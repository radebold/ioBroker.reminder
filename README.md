...
2. The child answers with something like `erledigt #TREPPE-4821`.
3. The adapter sends a confirmation request to the parent.
4. The parent answers with something like `ja #TREPPE-4821`.
...
## Repository / release workflow suggestion

Recommended next steps:

1. unpack this project into your Git repository
2. commit everything
3. push to GitHub
4. install it in ioBroker from your GitHub repository
